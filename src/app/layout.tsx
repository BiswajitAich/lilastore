...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    title: "LilaStore App",
    description:
      "Best Jewellery & Cosmetic website with affordable price range.",
  ...
  keywords:
    "Konnagar, Imitation Jewlry, Golden Necklace ,Golden Earring ,Golden Bangle ,Oxidized Necklace,Oxidized Earring ,Oxidized Bangle ,Terracotta Necklace ,Terracotta Earring ,Chemicalbead Necklace ,Kundan Necklace ,Fancy Necklace ,Choker, Mangalsutra ,Stone Earring ,AD Stone ,Funky Earring ,Fancy Earring ,Bracelets ,Mantasa ,Chains ,Kamarband ,Rings ,Payals ",
  robots: {
    index: false,
    follow: true,
    nocache: true,
  ...
  return (
    <html lang="en">
      <body className={inter.className}>
        ...
        <section className="warning-stopped">
          ⚠️ Warning - This website is for display purpose. We stopped taking
          orders. Thank You for your time.
        </section>
      </body>
    </html>
  );
