    ...
    return (
        <div className={Style.footerBody}>
            <div className={Style.container}>
                ...
                <div>
                    <a href='https://wa.me/9038810186' target="_blank" rel="noopener noreferrer">
                        <img src='https://biswajitaich.github.io/lilastore/images/logos/whatsapp-icon.webp' alt='ContactWhatsApp' /><p>WhatsApp</p>
                    </a>
                    ...
                    <a href='https://www.facebook.com/profile.php?id=100091896976745' target="_blank" rel="noopener noreferrer" >
                        <img src='https://biswajitaich.github.io/lilastore/images/logos/facebook-icon.webp' alt='ContactFacebook' /><p>Facebook</p>
                    </a>
                    <div style={{ minHeight: '50px', width: '5px', backgroundColor: 'white' }} />
                    <a href='https://instagram.com/suraviai?igshid=YWYwM2|1ZDdmOQ==' target="_blank" rel="noopener noreferrer">
                        <img src='https://biswajitaich.github.io/lilastore/images/logos/instagram-icon.webp' alt='ContactInsta' /><p>Instagram</p>
                    </a>
                </div>
            </div>
            ...
            <div className={Style.container}>
                ...
                <div>
                    <a href='https://www.facebook.com/profile.php?id=100091896976745' target="_blank" rel="noopener noreferrer" >
                        <img src='https://biswajitaich.github.io/lilastore/images/logos/facebook-icon.webp' alt='FollowFacebook' /><p>Facebook</p>
                    </a>
                    <div style={{ minHeight: '50px', width: '5px', backgroundColor: 'white' }} />
                    <a href='https://instagram.com/suraviai?igshid=YWYwM2|1ZDdmOQ==' target="_blank" rel="noopener noreferrer">
                        <img src='https://biswajitaich.github.io/lilastore/images/logos/instagram-icon.webp' alt='FollowInsta' /><p>Instagram</p>
                    </a>
                </div>
            </div>
