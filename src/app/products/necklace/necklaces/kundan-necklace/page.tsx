...
const KundanNecklaces: React.FC = () => {
            ...
            <div className={StyleScript.productBody}>
                ...
                <div className={StyleScript.productContainer}>
                    {productData.map((material, idx) => (
                        <Link href={`/products/necklace/necklaces/kundan-necklace/${material.id}`} ref={refs[idx]} className={StyleScript.reveal} key={idx}>
