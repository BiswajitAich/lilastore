...
const ChemicalbeadNecklaces: React.FC = () => {
            ...
            <div className={StyleScript.productBody}>
                ...
                <div className={StyleScript.productContainer}>
                    {productData.map((material, idx) => (
                        <Link href={`/products/necklace/necklaces/chemicalbead-necklace/${material.id}`} ref={refs[idx]} className={StyleScript.reveal} key={idx}>
                                ...
                                <div className={StyleScript.imageDiv}  >
                                    {
                                        <CldImage
                                            itemType='img'
                                            src={material.url}
                                            alt={`Chemical bead Necklace ${idx + 1}`}
                                            width={400}
                                            height={600}
                                            loading='lazy'
                                            style={{
