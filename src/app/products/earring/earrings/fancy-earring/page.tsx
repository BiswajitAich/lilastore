            ...
            <div className={StyleScript.productBody}>
                ...
                <div className={StyleScript.productContainer}>
                    {productData.map((material, idx) => (
                        <Link href={`/products/earring/earrings/fancy-earring/${material.id}`} ref={refs[idx]} className={StyleScript.reveal} key={idx}>
